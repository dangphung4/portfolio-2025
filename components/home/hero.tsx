              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <div className="flex flex-col text-sm text-muted-foreground">
                  <div className="flex items-center">
                    ...
                    <span>Currently at <span className="font-medium text-primary"><Link href="https://www.recro.com/" target="_blank" rel="noopener noreferrer">Recro Corporation</Link></span> as Software Engineer</span>
                  </div>
                </div>
              </div>
            </motion.div>
