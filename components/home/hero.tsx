      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            {/* Floating badges */}
            <motion.div
              className="absolute -top-4 -right-4 bg-background/80 backdrop-blur-sm border shadow-lg rounded-full px-3 py-1.5 text-sm font-medium"
            ...
            <motion.div
              className="absolute top-1/2 -left-8 bg-background/80 backdrop-blur-sm border shadow-lg rounded-full px-3 py-1.5 text-sm font-medium"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-background/80 backdrop-blur-sm border shadow-lg rounded-full px-3 py-1.5 text-sm font-medium"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
