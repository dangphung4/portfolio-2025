...
import { Code, Laptop, Briefcase, User, Github, Linkedin, Mail, ExternalLink, FileText } from "lucide-react"
  ...
  return (
    <section className="mb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          <Card className="h-full overflow-hidden border border-border/40 shadow-md dark:shadow-primary/5 rounded-xl">
        ...
        >
          <Card className="h-full border border-border/40 shadow-md dark:shadow-primary/5 rounded-xl">
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
                <div className="flex flex-col items-center text-center p-5 bg-muted/50 hover:bg-muted rounded-xl transition-colors">
